            ...
            <div class="card">
              <div class="card-header">
				<div class="d-flex justify-content-between align-items-center w-100">
					<h5 class="m-0">Adicionar artigo</h5>
				</div>
              </div>
              <div class="card-body">
  				<form method="post" action="<?= base_url('articles/store') ?>" enctype="multipart/form-data">
  					<div class="row">
					  	...
					  	<div class="form-group">
							<label for="customFile">Fotos</label>
							<div class="custom-file">
								<input type="file" name="photo[]" multiple accept="image/jpeg, image/svg, image/png, image/gif, image/jpg, image/bmp" value="<?=(isset($_SESSION['__formOld']['photo']) ? $_SESSION['__formOld']['photo'] : '')?>" class="custom-file-input" id="customFile">
